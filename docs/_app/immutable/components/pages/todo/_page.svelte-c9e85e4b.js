import{S as Rt,i as Ut,s as Ft,k as n,a as s,q as h,l as e,c as o,m as i,r as p,h as l,n as c,b as bt,D as t,B as Ot}from"../../../chunks/index-45205581.js";function Vt(qt){let D,S,f,g,w,q,z,G,A,R,U,M,F,V,d,Y,j,J,K,Q,B,W,r,v,X,Z,_,$,tt,b,rt,nt,O,et,at,T,lt,it,L,st,ot,P,ct,ht,k,pt,dt,C,gt,xt,y,mt,ft,H,ut,Et,I,Dt,vt,N,_t;return{c(){D=n("!DOCTYPE"),S=s(),f=n("html"),g=n("head"),w=n("meta"),q=s(),z=n("meta"),G=s(),A=n("title"),R=h("Todo App"),U=s(),M=n("style"),F=h(`h1 {\r
            color:black; \r
            text-align: center;\r
            font-size: 200%;\r
        }\r
